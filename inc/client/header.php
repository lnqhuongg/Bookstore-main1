    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary small">
        <div class="container">
          ...
          <a class="navbar-brand" href="">
            <img src="assets/client/img/logo-new.png" alt="logo">
          </a>
          ...
          <div class="collapse navbar-collapse ms-5" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 fw-normal ">
              ...
              <li class="nav-item me-3">
                <a class="nav-link " aria-current="page" href="">SÁCH</a>
              </li>
              <li class="nav-item me-3">
                <a class="nav-link " aria-current="page" href="">VĂN PHÒNG PHẨM</a>
              </li>
            </ul>
            <form class="d-flex" role="search">
              ...
              <!-- logo cart -->
              <a href="" class="cart-icon btn btn-success d-flex align-items-center rounded-5 me-3" >
              ...
              <div class="nav-item dropdown d-flex align-items-center rounded-5">
                ...
                <ul class="dropdown-menu" style="margin-left: -120px; margin-top: 10px">
                  <li><a class="dropdown-item" href="" style="--bs-dropdown-link-active-bg: #f2ebea; --bs-dropdown-link-active-color: black;">Thông tin cá nhân</a></li>
                  <li><hr class="dropdown-divider"></li>
                  <li><a class="dropdown-item" href="" style="--bs-dropdown-link-active-bg: #f2ebea; --bs-dropdown-link-active-color: black;">Đơn hàng</a></li>
                </ul>                    
              </div>
            </form>
        </div>
