        ...
        <div class="row d-flex align-items-center justify-content-center ">
            <div class="col-md-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-center">
                          Vui lòng nhập vào địa chỉ email của bạn, chúng tôi sẽ gửi mã xác nhận giúp bạn khôi phục mật khẩu.
                        </p>
                        <form class="row g-3 pb-3">
                            <div class="col-md-12">
                              <input placeholder="Nhập email..." type="email" class="form-control" id="validationDefault01" value="" required>
                            </div>
                            <div class="col-12 d-grid">
                              <a href="/assets/layout/client/rePassword2.html" class="btn btn-success" type="submit">Gửi mã</a>
                            </div>
