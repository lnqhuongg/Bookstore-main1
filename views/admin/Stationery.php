  ...
  <div class="row py-3 px-1 mb-2">
    ...
    <div class="col-md-11 d-flex">
      <form class="d-flex w-100">
          ...
          <input type="text" placeholder="Nhập mã, tên văn phòng phẩm..." style="max-width: 360px;" class="form-control me-4" id="">
                ...
                <tr>
                  ...
                  <!-- Hình ảnh sách -->
                    <td class="book-image text-center" scope="row">
                        <img src="/assets/uploads/vpp3.webp" style="width:120px" alt="">
                    </td>
                  <!-- Tên sách -->
                    ...
                    <td class="align-middle text-center">
                      <!-- Button xem thông tin chi tiết -->
                        ...
                        <!-- Button chỉnh sửa -->
                          ...
                          <button class="btn" fdprocessedid="r9x0b9" type="button" class="btn btn-success btn-sm open_edit_form" data-bs-toggle="modal" data-bs-target="#staticBackdropEdit">
  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="productModalLabel">Chỉnh sửa thông tin </h1>
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-md-9 px-3">
                <div class="row mb-3">
                  <label for="" class=" col-sm-2 col-form-label fw-medium text-start">Tên VPP</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="" placeholder="Nhập tên Văn phòng phẩm...">
                  </div>
                </div>
                <div class="row mb-3">
                  ...
                  <div class="col-md-6 d-flex justify-content-between">
                    <label for="" class="col-form-label fw-medium ">Phân loại</label>
                ...
                <div class="row mb-3">
                  <div class="col-md-6 d-flex justify-content-between">
                    <label for="" class="col-form-label fw-medium">Giá nhập</label>
                    <input type="text" class="form-control" id="" placeholder="Nhập giá nhập (đồng)" style="width: 255px">
                  </div>
                  <div class="col-md-6 d-flex justify-content-between">
                ...
                <div class="edit">
                  <div class="row mb-3 d-flex justify-content-center align-items-center edit">
...
<!-- ------------------------------------------------------------------------------------------------- -->
    ...
    <script src="../assets/admin/js/Stationery.js"></script>
